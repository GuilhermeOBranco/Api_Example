...
namespace DevIO.Api.Extensions
{
    ...
    {
        private readonly IOptions<JsonSerializer> _jsonOptions;
        private readonly FormFileModelBinder _formFileModelBinder;

        public JsonWithFilesFormDataModelBinder(IOptions<JsonSerializer> jsonOptions, ILoggerFactory loggerFactory)
        {
